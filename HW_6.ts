...
const c1: number = 1;
const c2: string = "";
const c3: [boolean, number] = [true, 5];
const c4: string[] = [];
...
let b4: { a: boolean; b: boolean; [key: string]: boolean } = {
  a: true,
  b: false,
};
b4["c"] = false;
...
*/
function a1(a: number): void {}
function a2(a: string | number, b: boolean): void {}
function a3(a?: { f1?: string }): void {}
function a4(): number {
  return 1;
}
